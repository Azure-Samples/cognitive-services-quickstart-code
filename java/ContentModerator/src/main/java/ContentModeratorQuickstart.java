 ...
 * https://docs.microsoft.com/en-us/java/api/overview/azure/cognitiveservices/client/contentmoderator?view=azure-java-stable
 * - Content Moderator API:
 * https://docs.microsoft.com/en-us/azure/cognitive-services/content-moderator/api-reference
 */
